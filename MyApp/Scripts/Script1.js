$(document).ready(function () {
    ...
    $("#btnAddRow").on("click", function (e) {
        $("#skillTable").append("<tr class=dynamic_row><td><input class=skill_name contenteditable=true type=text/></td><td><input class=skill_description contenteditable=true type=text /></td></tr>");
    ...
    function GetUsersDatabase() {
        ...
        $.ajax({
            ...
            alert("Users list preview failed!");
        });
    }
